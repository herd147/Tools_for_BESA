# Tools_for_BESA
Some code which can be used for BESA swf processing and more
...
bootstrap_quality_scatters: if you try different slice-values you can optimize the time slices for bootstrap-analysis (perform simple_bca_bootstrap first)
